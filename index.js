...
function addGroup(event) {
  ...
  groupItem.innerHTML = `
    <h4 ondblclick="editText(event)">Group Item_20204517</h4>
...
function addInfo(event) {
  ...
  infoItem.innerHTML = `
    <label ondblclick="editText(event)">Info Item Name_20204517</label>
...
function handleDelete(event) {
  if (
    confirm(
      "Thông báo tới: Lại Trọng Chiến - 20204517\nBạn có chắc chắn muốn xóa mục này?"
    )
  )
  ...
  html2canvas($("#main")[0], {
    onrendered: function (canvas) {
      ...
      pdfMake
        ...
        .download("Thông tin sinh viên 20204517.pdf");
    },
  });
});
